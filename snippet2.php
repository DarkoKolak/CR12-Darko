...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    <li class="nav-item">
      <a href="adminindex.php" class="nav-link text-dark font-italic bg-light">
                <i class="fa fa-th-large mr-3 text-primary fa-fw"></i>
                Home
            </a>
    </li>
    <li class="nav-item">
      <a href="adminconcerts.php" class="nav-link text-dark font-italic">
                <i class="fa fa-address-card mr-3 text-primary fa-fw"></i>
                Concerts
            </a>
    </li>
    <li class="nav-item">
      <a href="adminrestaurant.php" class="nav-link text-dark font-italic">
                <i class="fa fa-cubes mr-3 text-primary fa-fw"></i>
                Restaurants
            </a>
    </li>
    <li class="nav-item">
      <a href="adminthingstodo.php" class="nav-link text-dark font-italic">
